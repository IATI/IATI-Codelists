...
* Do your work
    ...
    - If your work involves modifying a Non-Embedded Codelist, create a separate pull request to `update the changelog <https://github.com/IATI/IATI-Guidance/blob/master/en/upgrades/nonembedded-codelist-changelog.rst>`__ and add a link from one to the other.
